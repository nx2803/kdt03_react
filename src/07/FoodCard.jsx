...
const [isActive, setIsActive] = useState(true);
    ...
    const bordertrue = isActive ? 'border-3' : 'broder-0';
  ...
  return (
    <div className='border-3 border-dashed border-white text-white flex flex-row'>
      ...
      <div className='w-3/4 flex flex-col mx-6 mt-6 justify-between gap-y-1'>
        ...
        <p>{location}</p>
        <div className={`flex flex-row h-10 mt-6 mb-4 px-2 gap-x-2 items-center shadow border-white border-dashed ${bordertrue}`} onClick={handleClick}>
